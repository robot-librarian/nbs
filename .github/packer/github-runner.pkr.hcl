...
source "yandex" "github-runner" {
  ...
  image_name          = "${var.IMAGE_PREFIX}-${var.IMAGE_FAMILY_NAME}-${var.NIGHTLY_RUN_ID}"
  image_description   = "repo:${var.REPOSITORY} run_id:${var.BUILD_RUN_ID} nightly_run_id:${var.NIGHTLY_RUN_ID} created_at:${local.current_date}"
  image_pooled        = "true"
